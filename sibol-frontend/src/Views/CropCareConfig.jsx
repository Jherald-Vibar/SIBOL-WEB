...
const AdminCropProfile = () => {
  ...
  const addCrop = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Success!',
        text: 'Crop profile added successfully',
        confirmButtonColor: '#114320',
        timer: 2000,
  ...
  const updateCrop = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Updated!',
        text: 'Crop profile updated successfully',
        confirmButtonColor: '#114320',
        timer: 2000,
        showConfirmButton: false
      });
  ...
  const deleteCrop = async (cropId) => {
    ...
    try {
      ...
      const response = await axiosClient.delete(`/deleteAdminCrop/${cropId}`);
      ...
      Swal.fire({
        icon: 'success',
        title: 'Deleted!',
        text: 'Crop profile has been deleted successfully',
        confirmButtonColor: '#114320',
        timer: 2000,
        showConfirmButton: false
      });
  ...
  const fetchCrops = async () => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error!',
        text: 'Failed to load crop profiles',
        confirmButtonColor: '#dc2626'
      });
            ...
            {crops.map((crop) => (
              <div key={crop.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200">
                ...
                <div
                  ...
                  className="bg-gradient-to-r from-[#E8DCC4] to-[#d4c9ad] px-6 py-4 cursor-pointer hover:from-[#ddd4bd] hover:to-[#cac0a4] transition-all flex justify-between items-center"
                >
                ...
                {expandedCrop === crop.id && (
                  <div className="overflow-hidden">
                    ...
                    {/* Action Buttons */}
                    <div className="bg-gray-50 px-6 py-4 flex flex-col sm:flex-row gap-3 justify-end border-t-2 border-gray-300">
                      <button
