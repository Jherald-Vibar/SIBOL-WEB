      ...
      <div className="px-4 sm:px-8 lg:px-16 py-10 pb-24 md:pb-12 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl space-y-5">
          ...
          <div className=" bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6">
            ...
            <div>
              ...
              <div className={inputBox}>
                <input type="text" placeholder="e.g. John Doe" className={inputText} readOnly />
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className={inputBox}>
                    ...
                    <button type="button" className="text-xs text-green-600 font-semibold hover:text-green-700 shrink-0">Change</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleChangePass}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <div className={inputBox}>
                      {lockIcon}
                      <input type={showCurrent ? 'text' : 'password'} name="current_password" value={form.current_password} onChange={handleChange} placeholder="••••••••••••••" className={inputText} />
                      <button type="button" onClick={() => setShowCurrent(v => !v)} className="text-gray-400 hover:text-gray-600 shrink-0"><EyeIcon open={showCurrent} /></button>
                    </div>
                  </div>
                  {/* New Password */}
                  <div>
                    ...
                    <div className={`${inputBox} ${!passwordsMatch && form.confirm_password ? '!border-red-300 !ring-2 !ring-red-100' : ''}`}>
                      {lockIcon}
                      <input type={showNew ? 'text' : 'password'} name="new_password" value={form.new_password} onChange={handleChange} placeholder="••••••••••••••" className={inputText} />
                      <button type="button" onClick={() => setShowNew(v => !v)} className="text-gray-400 hover:text-gray-600 shrink-0"><EyeIcon open={showNew} /></button>
                    </div>
                    {/* Strength bar */}
                    {form.new_password && (
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 items-end">
                  <div>
                    ...
                    <div className={`${inputBox} ${!passwordsMatch && form.confirm_password ? '!border-red-300 !ring-2 !ring-red-100' : ''}`}>
                      {lockIcon}
                      <input type={showConfirm ? 'text' : 'password'} name="confirm_password" value={form.confirm_password} onChange={handleChange} placeholder="••••••••••••••" className={inputText} />
                      <button type="button" onClick={() => setShowConfirm(v => !v)} className="text-gray-400 hover:text-gray-600 shrink-0"><EyeIcon open={showConfirm} /></button>
                    </div>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3">
                    <button type="button" className="text-xs text-gray-400 hover:text-gray-600 font-medium transition-colors">Set Password</button>
                    <button
                      type="submit"
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <p className="text-[14px] text-black/60 mb-4">If you no longer want to use SIBOL, you can permanently delete your account.</p>
            <button type="button" className="flex items-center gap-2 bg-red-500/70 hover:bg-red-500 text-white text-sm font-semibold px-5 py-2 rounded-full transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
              </svg>
              Delete my account
