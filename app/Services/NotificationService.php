...
{
    /**
     * Single private helper — every notification goes through here.
     * Creates the DB record then immediately broadcasts it over WebSocket.
     */
    ...
    private function checkSoilMoisture(SensorData $sensorData, User $user, Esp $esp, ?CropProfile $cropProfile): void
    {
        ...
        $criticalThreshold = $minMoisture * 0.5;
