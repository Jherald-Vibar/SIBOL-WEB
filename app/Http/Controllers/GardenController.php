    ...
    public function getGardenData(Request $request) {
        ...
        public function addCrop (Request $request, $gardenId) {
            ...
            if($request->hasFile('image')) {
                ...
                $file->move(public_path('crops_image'), $fileName);
      ...
      public function getSensorDataCrop(Request $request, $garden_id, $crop) {
        ...
        if ($latestData && $profile) {
            ...
            // Electrical Conductivity Alert (if you have this field in sensor data)
            ...
            // Air Temperature Alert (if you have this field in sensor data)
            ...
            // Air Humidity Alert (if you have this field in sensor data)
